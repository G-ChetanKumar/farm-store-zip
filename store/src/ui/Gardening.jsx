  ...
  useEffect(() => {
    const fetchGardeningProducts = async () => {
      try {
        ...
        // Find the "Gardening" category
        const gardeningCategory = categories.find(
          (category) => category.title === "Gardening/Polyhouse"
        );

        if (gardeningCategory) {
          const categoryId = gardeningCategory._id;
      ...
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="flex items-center space-x-1">
            <a
              href="/products?category=Gardening/Polyhouse"
