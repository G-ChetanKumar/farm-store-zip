...
const HouseholdPublic = () => {
  ...
  useEffect(() => {
    const fetchHouseholdProducts = async () => {
      try {
        setLoading(true);
        setError(false);
        ...
        if (householdCategory) {
          const categoryId = householdCategory._id;
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center min-h-[200px] text-center">
            <p className="text-red-500 text-md font-medium">
              Unable to fetch household products. Please check your internet
              connection.
            </p>
            <button
              onClick={handleRetry}
...
export default HouseholdPublic;
