...
import { useSearch } from "../../contexts/EmedsSearch";
...
import CategoriesLaptopView from "./CategoriesLaptopEmeds";
import CategoriesMobileView from "./CategoriesMobileEmeds";
...
const EmedsHeader = () => {
  ...
  const [selectedService, setSelectedService] = useState(services[2].key);
