                    ...
                    <div className="ml-4 pb-2">
                      <ul className="space-y-1">
                        {filteredSubCategories.map((sub) => (
                          <li key={sub._id}>
                            <Link
                              to={`/categories/${category._id}/subcategory/${sub._id}/products?brandName=${encodeURIComponent(sub.title)}`}
...
export default CategoriesMobileEfresh;
