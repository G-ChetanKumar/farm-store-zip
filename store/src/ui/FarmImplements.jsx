...
const FarmImplements = () => {
  ...
  useEffect(() => {
    const fetchFarmImplementProducts = async () => {
      try {
        setLoading(true);
        setError(false);
        ...
        // Find the "Farm Implements" category
        const farmImplementsCategory = categories.find(
          (category) => category.title === "Farm Implements/Tools/Equipments"
        );

        if (farmImplementsCategory) {
          const categoryId = farmImplementsCategory._id;
        ...
        console.error("Error fetching farm implements products:", error);
        setError(true);
      } finally {
    ...
    <section className="py-1 bg-gray-100">
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          <h2 className="text-lg sm:text-2xl font-bold text-gray-800 leading-tight whitespace-pre-wrap break-words">
            Farm Implements/Tools
          </h2>
          <div className="flex items-center space-x-1">
            <a
              href="/products?category=Farm Implements/Tools/Equipments"
