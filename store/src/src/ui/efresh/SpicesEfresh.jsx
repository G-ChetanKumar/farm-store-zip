    ...
    const fetchIrrigationProducts = async () => {
      try {
        ...
        const irrigationCategory = categories.find(
          (category) => category.title === "Spices,Salt/Sugar"
        );
        ...
        console.error("Error fetching Spices products:", error);
        setError(true);
      } finally {
      ...
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="flex items-center space-x-1">
            <a
              href="/freshproducts?category=Spices,Salt/Sugar"
