      ...
      {loading ? (
        ...
        <div className="grid grid-cols-3 md:grid-cols-8 gap-3 p-1">
          {displayedCategories.map((item) => (
            <Link
              to={`/categories/${item.category_id}/subcategory/${item._id}/products?brandName=${encodeURIComponent(item.title)}`}
              key={item._id}
...
export default EfreshCategories;
