    ...
    const fetchIrrigationProducts = async () => {
      try {
        ...
        const irrigationCategory = categories.find(
          (category) => category.title === "Noodles/Pasta"
        );
        ...
        console.error("Error fetching Noodles products:", error);
        setError(true);
      } finally {
  ...
  const handleRetry = () => {
    ...
    const fetchIrrigationProducts = async () => {
      try {
        ...
        console.error("Error fetching Noodles/Pasta products:", error);
        setError(true);
      } finally {
        setLoading(false); // Stop loading
      }
      ...
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="flex items-center space-x-1">
            <a
              href="/freshproducts?category=Noodles/Pasta"
