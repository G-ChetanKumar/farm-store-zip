  ...
  const handleRetry = () => {
    ...
    const fetchIrrigationProducts = async () => {
      try {
        ...
        // Find the "Irrigation" category
        const irrigationCategory = categories.find(
          (category) => category.title === "Irrigation"
        );
    ...
    <section className="bg-gray-100">
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          <h2 className="text-lg sm:text-2xl font-bold text-gray-800">Dairy</h2>
          <div className="flex items-center space-x-1">
            <a
              href="/freshproducts?category=Dairy"
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center min-h-[200px] text-center">
            <p className="text-red-500 text-md font-medium">
              Unable to fetch Dairy products. Please check your internet
              connection.
            </p>
            <button
              onClick={handleRetry}
