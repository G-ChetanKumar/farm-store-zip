  ...
  useEffect(() => {
    const fetchIrrigationProducts = async () => {
      try {
        ...
        console.error("Error fetching OIL'S products:", error);
        setError(true);
      } finally {
    ...
    <section className="py-1 bg-gray-100">
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          <h2 className="text-lg sm:text-2xl font-bold text-gray-800">OIL'S</h2>
          <div className="flex items-center space-x-1">
            <a
              href="/freshproducts?category=OIL'S"
