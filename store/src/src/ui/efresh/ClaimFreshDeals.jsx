...
const ClaimFreshDeals = () => {
  ...
  // State to store logged-in user's type
  ...
  // First, fetch the e-fresh category ID
  useEffect(() => {
  ...
  // Then, fetch and filter products based on the e-store supercategory
  useEffect(() => {
    if (!eStoreId) return;
  ...
  // Modified handleAddToCart uses getPackageData
...
export default ClaimFreshDeals;
