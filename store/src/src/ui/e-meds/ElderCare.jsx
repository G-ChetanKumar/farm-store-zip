...
const ElderCare = () => {
    ...
    const fetchIrrigationProducts = async () => {
      try {
        ...
        const irrigationCategory = categories.find(
          (category) => category.title === "Elderly Care"
        );
        ...
        console.error("Error fetching Elderly Care products:", error);
        setError(true);
      } finally {
  ...
  const ProductDialog = ({ product, onClose, isOpen }) => {
    ...
    const handleAddToCart = (product, pkg) => {
      ...
      if (isItemInCart(product._id, pkg._id)) {
      ...
      <div className="px-2 sm:px-4">
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="flex items-center space-x-1">
            <a
              href="/medproducts?category=Elderly Care"
