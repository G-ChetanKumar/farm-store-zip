...
const CategoriesLaptopEmeds = ({ categories, subCategories }) => {
        ...
        >
          <ul>
            {getFilteredSubCategories(activeCategory).map((sub) => (
              ...
              >
                <Link
                  to={`/medcategory/${activeCategory}/subcategory/${sub._id}/products?brandName=${encodeURIComponent(sub.title)}`}
                >
                  {sub.title}
                </Link>
              </li>
...
export default CategoriesLaptopEmeds;
